...
<div class="offcanvas offcanvas-start bg-success text-white" id="mobileSidebar">
 ...
 <!--main content-->
       <main class="col">
         <h1 class="text-center m-4">Add income</h1>
         <p>Record any new income to update your savings and budget.</p>
         <div class="row">
          <div class="col">
           <div class="card p-2">
            <form action="">
              <div class="row mb-3">
                <div class="col-md-6">
                  ...
                  <input type="text" class="form-control" id="incomeSource" placeholder="enter your source of income">
                </div>
                <div class="col-md-6">
              ...
              <div class="row mb-3">
                <div class="col-md-6">
                  <label for="incomeDate" class="form-label">Date Received</label>
         ...
         <div class="row mt-5">
          <div class="col">
            <div class="card p-3 mt-4" style="width: 500px;">
              <h6>Total Income This Month: ₦25,000</h6>
