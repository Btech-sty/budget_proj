...
<!--main content-->
<main class="col">
    <h1 class="text-center m-4 text-success">BUDGET</h1>
    <div class="row">
     <div class="col">
      <div class="card p-2">
       <form action="">
         ...
         <div class="row mt-3">
           <div class="col">
            <label for="save" class="form-label">Target budget</label>
            <input type="text" class="form-control" id="save" placeholder="Enter the target budget">
           </div>
         </div>
    ...
    <div class="row mt-5">
     <div class="col">
        ...
        <div class="progress mt-4" role="progressbar" aria-label="Success example" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100">
            <div class="progress-bar text-bg-success" style="width: 20%">budget: 25%</div>
          </div>
     </div>
    </div>
</main>
